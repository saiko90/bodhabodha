export const MOCK_PRODUCTS = {
  ...
  yellow: {
    id: 'prod_yellow',
    name: 'Yellow Mellow - Vibe Tee',
    price: 29.99,
    image: '/images/Tshirt_Yellow.jpg',
    url: 'https://bodhabodha.com/shop/yellow'
  },
  green: {
    id: 'prod_green',
    name: 'Green Scene - Vision Tee',
    price: 29.99,
    image: '/images/Tshirt_Green.jpg',
    url: 'https://bodhabodha.com/shop/green'
  },
  trueblue: {
    id: 'prod_blue',
